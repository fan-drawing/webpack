export default class SpriteUtilities { 
    constructor(renderingEngine = PIXI) {
        ...
        this.renderer = "";
        let ParticleContainer = (typeof renderingEngine.particles == undefined) ? renderingEngine.particles.ParticleContainer:renderingEngine.ParticleContainer;
        let Extras = (typeof renderingEngine.extras == undefined) ? renderingEngine.extras:renderingEngine;
        //If the `renderingEngine` is Pixi, set up Pixi object aliases
        if (ParticleContainer && renderingEngine.Sprite) {
            this.renderer = "pixi";
            ...
            this.MovieClip = Extras.AnimatedSprite;

            this.BitmapText = Extras.BitmapText;
            this.Sprite = renderingEngine.Sprite;
            this.TilingSprite = Extras.TilingSprite;
